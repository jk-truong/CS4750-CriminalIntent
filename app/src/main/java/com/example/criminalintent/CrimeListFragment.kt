...
class CrimeListFragment : Fragment() {
    ...
    //This lets the fragment manager know that crimelistfragment needs to receive menu callbacks.
    ...
    //This inflates a menu
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        super.onCreateOptionsMenu(menu, inflater)
        inflater.inflate(R.menu.fragment_crime_list, menu)
    }

    //This responds to menu selection
    ...
    //Here's the adapter
    //The adapter: creates Viewholders and binds viewholders to data
    private inner class CrimeAdapter(var crimes: List<Crime>)
        : RecyclerView.Adapter<CrimeHolder>() {

        //Add new property requiresPolice to the Crime object
